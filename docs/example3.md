...
The `Example 3` behavior constructs a HFSM with a `ConcurrencyContainer`(https://github.com/FlexBE/flexbe_behavior_engine/blob/ros2-devel/flexbe_core/flexbe_core/concurrency_container.py).
...
<img src="../img/example3_onboard_or.png" alt="Example 3 onboard terminal logging during Concurrent_OR" width="450">
<img src="../img/example3_onboard_and.png" alt="Example 3 onboard terminal logging during Concurrent_AND." width="450">
...
This behavior is defined in []`example_3_sm.py`](flexbe_turtlesim_demo_flexbe_behaviors/flexbe_turtlesim_demo_flexbe_behaviors/example_3_sm.py).  All of that code (listed below) is generated by the FlexBE UI state machine editor and saved via the dashboard.  
