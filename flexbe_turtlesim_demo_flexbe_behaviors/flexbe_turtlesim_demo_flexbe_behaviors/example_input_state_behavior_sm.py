...
"""
Define Example Input State Behavior.
...
class ExampleInputStateBehaviorSM(Behavior):
	"""
	Define Example Input State Behavior.

	A demo for Input State functionality.
	"""

	def __init__(self, node):
		super().__init__()
		self.name = 'Example Input State Behavior'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('InputState',
										InputState(message="Enter an angle: "),
			...
			OperatableStateMachine.add('RotateTurtleState',
										...
										remapping={'angle': 'data', 'duration': 'duration'})
