    ...
    def create(self):
        ...
        with _state_machine:
            ...
            OperatableStateMachine.add('Operator',
                                        OperatorDecisionState(outcomes=["Home", "Eight", "Quit", "Clear", "Rotate"], hint="Eight", suggestion="Eight"),
                                        transitions={'Home': 'GoHome', 'Eight': 'Container', 'Quit': 'finished', 'Clear': 'ClearLog', 'Rotate': 'Turtlesim Input State Behavior'},
                                        autonomy={'Home': Autonomy.Full, 'Eight': Autonomy.High, 'Quit': Autonomy.Full, 'Clear': Autonomy.Full, 'Rotate': Autonomy.Low})
