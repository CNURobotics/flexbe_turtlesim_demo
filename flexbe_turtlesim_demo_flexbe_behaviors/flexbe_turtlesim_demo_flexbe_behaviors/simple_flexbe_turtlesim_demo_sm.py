...
###########################################################
"""
Simple TurtleSim Demo of FlexBE.
    ...
    def create(self):
        ...
        with _state_machine:
            ...
            OperatableStateMachine.add('Operator',
                                       OperatorDecisionState(outcomes=["Home", "Eight", "Quit", "Clear"],
                                                             hint="Eight", suggestion="Eight"),
                                       transitions={'Home': 'GoHome', 'Eight': 'Container',
                                                    'Quit': 'finished', 'Clear': 'ClearLog'},
